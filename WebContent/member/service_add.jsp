...
<%
	...
	PreparedStatement pstmt = DriverManager.getConnection(ORACLE_URL, USERNAME, PASSWORD).prepareStatement("insert into member(id, name, pw, ssn, regdate) values (?, ?, ?, ?, sysdate)");
